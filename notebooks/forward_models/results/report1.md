...
Parameter Group 0
    ...
    weight_decay: 0
        ...
        DataLoader Params: 
            Batch Size: 32
            Validation Method: Holds out fMaternal Wall Thickness columns 0.0 for validation. The rest are used             for training
        Loss:
            Train Loss: 0.003049967831454028
            Val. Loss: 0.032699287124963665
```  

# Loss Curves
  
  
![Loss Curves](figures/report1_3.png)  

# Prediction Distribution
  
  
![Prediction Distribution](figures/report1_4.png)  

# Error Distribution
  
  
![Error Distribution](figures/report1_5.png)  
