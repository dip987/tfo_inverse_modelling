...
Making the network deeper to see if it can still learn the data  
...
```
  ...
  (model): Sequential(
    ...
    (11): ReLU()
    (12): Linear(in_features=15, out_features=15, bias=True)
    (13): BatchNorm1d(15, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    (14): Dropout1d(p=0.01, inplace=False)
    (15): ReLU()
    (16): Linear(in_features=15, out_features=20, bias=True)
...
Parameter Group 0
    ...
    weight_decay: 0
        ...
        Loss:
            Train Loss: 0.002299783353990145
            Val. Loss: 0.041742438598284644
```  

# Loss Curves
  
  
![Loss Curves](figures/report5_4.png)  

# Prediction Distribution
  
  
![Prediction Distribution](figures/report5_5.png)  

# Error Distribution
  
  
![Error Distribution](figures/report5_6.png)  
